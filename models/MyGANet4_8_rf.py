...
class GANet(nn.Module):
    ...
    def forward(self, x, y):
        ...
        disp1 = self.Res_Pred11(res_cv1)
        disp1 = upsample(h, w)(disp1)
        disp1 = disp0 + disp1
        # return disp0, disp1, disp1

        disp2 = upsample(h / 2, w / 2, keep_dim=True)(disp1)
        # x2 = self.conv_x22(x2)
        # y2 = self.conv_y22(y2)
        res_cv2 = self.Res_cv2(x2, disp2, y2)
        disp2 = self.Res_Pred22(res_cv2)
        disp2 = upsample(h, w)(disp2)
        disp2 = disp1 + disp2
        return disp2
        # TODO out2
